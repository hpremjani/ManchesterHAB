...
// The getgps function will get and print the values we want.
  ...
  float hour, minute, seconds,latitude, longitude,height,temperature,pressure;
  char hr[10];
  char mn[10];
  char scs[10];  
  char lat[10];
...
latlon=(" Hour: " + hrcell +, " Minutes: " + mncell +, " Seconds: " + scscell+, " Latitude: " + latcell +, " Longitutde: " + longcell, " Altitude: " + altcell +, " Temperature: " + tmpcell +, " Pressure: " + prcell +);
